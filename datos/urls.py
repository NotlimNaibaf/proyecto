...
from.views import (
    RegistroUsuarioView, CustomLoginView, ListaCursosView, DetalleCursoView, CrearCursoView, MisCursosView,
InscribirCursoView, CustomLogoutView
)
...
urlpatterns = [
    ...
    path('curso/<int:pk>/inscribir/', InscribirCursoView, name='incribir_curso'),
